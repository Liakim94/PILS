...
public class EncDecSupportUtil {
	private String ivKey = "c2Z7yx8z4GLA#0zc"; //초기화 벡터
	private String encKey = "A!e1$c1XS45Iy04A"; //암호화 키
	 ...
	 * @param target
	 */
	public String DecryptAesStringToHex(String target) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException {
		SecretKeySpec key = new SecretKeySpec(encKey.getBytes(), "AES");
		IvParameterSpec initalVector = new IvParameterSpec(ivKey.getBytes());
		Cipher cipher = Cipher.getInstance("AES/CFB8/NoPadding");		// AES/CFB/NoPadding | AES/CFB8/NoPadding
