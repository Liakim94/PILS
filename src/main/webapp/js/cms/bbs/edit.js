		...
		success : function(data){
			...
			if(response.length > 0){
				$.each(response, function(index, item){
					var typ = item.authTyp;
					var rwx = item.authRwx;
					var r = rwx.substring(0, 1);
					var w = rwx.substring(1, 2);
					var x = rwx.substring(2, 3);
					var seq = item.authSeq;
					
					
					if(typ == "D"){
						
						if(rwx === 'RWX'){
							$('input[type="checkbox"][name="dept_'+seq+'"][value="A"]').iCheck("check");
						}else{
							$('input[type="checkbox"][name="dept_'+seq+'"][value="A"]').removeAttr("checked").iCheck("update");
							if(r === 'R') $('#dept_auth input[type="checkbox"][name="dept_'+seq+'"][value="R"]').iCheck("check");
							else $('input[type="checkbox"][name="dept_'+seq+'"][value="R"]').removeAttr("checked").iCheck("update");
							
							if(w === 'W') $('input[type="checkbox"][name="dept_'+seq+'"][value="W"]').iCheck("check");
							else $('input[type="checkbox"][name="dept_'+seq+'"][value="W"]').removeAttr("checked").iCheck("update");
							
							if(x === 'X') $('input[type="checkbox"][name="dept_'+seq+'"][value="X"]').iCheck("check");
							else $('input[type="checkbox"][name="dept_'+seq+'"][value="X"]').removeAttr("checked").iCheck("update");
						}
					}
					if(typ == "G"){
						if(rwx === 'RWX'){
							$('input[type="checkbox"][name="grp_'+seq+'"][value="A"]').iCheck("check");
						}else{
							$('input[type="checkbox"][name="grp_'+seq+'"][value="A"]').removeAttr("checked").iCheck("update");
							if(r === 'R') $('input[type="checkbox"][name="grp_'+seq+'"][value="R"]').iCheck("check");
							else $('input[type="checkbox"][name="grp_'+seq+'"][value="R"]').removeAttr("checked").iCheck("update");
							
							if(w === 'W') $('input[type="checkbox"][name="grp_'+seq+'"][value="W"]').iCheck("check");
							else $('input[type="checkbox"][name="grp_'+seq+'"][value="W"]').removeAttr("checked").iCheck("update");
							
							if(x === 'X') $('input[type="checkbox"][name="grp_'+seq+'"][value="X"]').iCheck("check");
							else $('input[type="checkbox"][name="grp_'+seq+'"][value="X"]').removeAttr("checked").iCheck("update");
						}
					}
					if(typ == "E"){
						if(rwx === 'RWX'){
							$('input[type="checkbox"][name="emp_'+seq+'"][value="A"]').iCheck("check");
						}else{
							$('input[type="checkbox"][name="emp_'+seq+'"][value="A"]').removeAttr("checked").iCheck("update");
							if(r === 'R') $('input[type="checkbox"][name="emp_'+seq+'"][value="R"]').iCheck("check");
							else $('input[type="checkbox"][name="emp_'+seq+'"][value="R"]').removeAttr("checked").iCheck("update");
							
							if(w === 'W') $('input[type="checkbox"][name="emp_'+seq+'"][value="W"]').iCheck("check");
							else $('input[type="checkbox"][name="emp_'+seq+'"][value="W"]').removeAttr("checked").iCheck("update");
							
							if(x === 'X') $('input[type="checkbox"][name="emp_'+seq+'"][value="X"]').iCheck("check");
							else $('input[type="checkbox"][name="emp_'+seq+'"][value="X"]').removeAttr("checked").iCheck("update");
						}
					}
