...
$(function(){
	...
	$("#form").validate({
        ...
        rules: {
        	...
        	passwd:{required:true, passwordCk:true, minlength:8, maxlength:16},
        	passwd2:{required:true, equalTo: "#strPwd"},
        	auth : {required:true},
        ...
        messages: {
        	...
        	passwd:{required:"비밀번호를 입력하세요.", passwordCk:"영문,숫자,특수문자 조합이어야 합니다.", minlength:"비밀번호는 {0}자 이상입니다.", maxlength:"비밀번호는 {0}자 이하입니다."},
        	passwd2:{required:"비밀번호확인을 입력하세요.", equalTo:"비밀번호가 일치하지 않습니다."},
