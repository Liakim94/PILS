...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		...
		//var sPopupUrl = "/js/se/popup/quick_photo/Photo_Quick_UploadPopup.jsp";
		var sPopupUrl = "./se2/photo_uploader/Photo_Quick_UploadPopup.jsp";
		//var sPopupUrl = "../se2/photo_uploader/photoQuickUploadPopup.do";
