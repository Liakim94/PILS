...
//    	sUploadURL= 'http://test.naver.com/popup/quick_photo/FileUploader_html5.php'; 	//upload URL
		...
		sUploadURL = root+'/common/editor/photo_uploader/upload.do';
	...
	function onAjaxError (){
		alert("[가이드]사진 업로더할 서버URL셋팅이 필요합니다.-onAjaxErrorqqq"); //설치 가이드 안내 문구임. 실 서비스에서는 삭제. 
	}
 	...
 	function callFileUploader (){
 		...
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 	        ...
 	        //sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.do',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
