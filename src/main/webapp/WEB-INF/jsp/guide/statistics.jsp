        ...
        <div class="article">
            ...
            <div id="about" class="content">
                ...
                <section>
                    ...
                    <h4 class="mb40">
                        연동의 대상이 되는 <strong>주요 원재료</strong>는 구체적으로 철스크랩, 압연강재(후판, 박판, 봉강, 선재 등), 도금강재, 강관, 선철 등의 <strong>철강류가 49.9%</strong>로 가장 많았습니다.<br>
                        <br>
                        다음으로 동, 알루미늄, 아연, 납, 주석, 은, 니켈 등의 <strong>비철금속은 31.1%</strong>를 차지했다. 합성수지(PP, PA, ABS, GPPS 등), 합성고무(NBR, CR, EPDM, FKM 등), 에틸렌, 나프타 등의 <strong>석유화학 원재료가 10.9%</strong>로 뒤를 이었습니다.<br>
                        <br>
                ...
                <section>
                    ...
                    <h4 class="mb40">
                        원재료의 가격 변동 정도를 확인할 수 있는 <strong>원재료 가격 기준지표</strong>로 <strong>원자재 거래소</strong>(런던금속거래소 등), <strong>중소기업협동조합</strong>(한국주물공업협동조합, 한국전선공업협동조합 등), <strong>전문가격조사기관</strong>(한국물가정보, 한국물가협회 등), <strong>전문지</strong>(철강금속신문, 스틸데일리 등) 등 <strong>공신력 있는 기관이 고시하는 지표</strong>를 활용하는 경우가 <strong>65.6%</strong>로 가장 많았습니다.<br>
                        <br>
                        <strong>특정 원재료 판매처의 공시 가격</strong>을 활용하는 사례도 <strong>14.6%</strong>를 차지했습니다.<br>
                        연동제를 <strong>오랜 기간 운영해온 기업</strong> 중에는 여러 원재료 판매처 가격의 평균값을 지표로 활용하는 경우도 있었습니다.
                    </h4>
                ...
                <section>
                    ...
                    <h4 class="mb40">
                        원재료 가격 변동률에 따른 <strong>조정 요건</strong>은 <strong>‘0%’</strong>가 <strong>48.6%</strong>로 <strong>원재료 가격이 1원만 변경돼도 납품대금을 조정하는 사례가 절반</strong> 정도인 것으로 나타났으며, <strong>±3% 이하 조정 요건</strong>까지 포함하면 <strong>64.1%</strong>까지 늘어납니다.<br>
                        <br>
                        <strong>±10%를 초과한 조정 요건</strong>을 설정한 사례는 <strong>0.4%</strong>에 불과했습니다.<br>
                        <br>
                        또한, 99.7%의 사례에서는 원재료 가격의 <strong>상승, 하락 모두를 연동</strong>되도록 정하고 있었습니다.
                    </h4>
                ...
                <section>
                    ...
                    <h4 class="mb40">
                        ...
                        <br>
                        1년으로 길게 잡은 경우도 있었으며, 수시로 정한 경우는 원재료 가격 변동시, 유상사급(위탁기업이 수탁기업에 원재료를 판매) 거래시, 납품시 마다 조정하는 경우입니다.
                    </h4>
