            ...
            <div id="about" class="content">
                <section class="font16 point4-text">
                    ...
                    <div class="accordion-container">
                        ...
                        <p class="mt60">약정서에 적어야 할 납품대금 연동에 관한 사항은 “약정서 작성하기” 페이지에서 확인할 수 있습니다.</p>
                        <p class="mt30">
                            ...
                            <span class="font14 mt10 mb30 point9-text tip">
                                    ※ 관련법령: 개정 ｢대·중소기업 상생협력 촉진에 관한 법률｣ [2023.1.3. 일부개정] 제2조 제13호
                                </span>
                        </p>
                        ...
                        <div class="item-wrap mt20 mb10" onclick="detailOpen(this)" tabindex="1">
                            <h3 class="text-mobile">2. ｢상생협력법｣에서 정하는 예외 사유란?</h3>
                            <img class="icon" src="<c:url value="/images/common/arrow-top.png"/>" alt="법률 상세보기">
                            <div class="detail-info">
                                <ul class="list-none">
                                    <li>
                    ...
                    <h2 class="title title-amend mt60"><strong>참고</strong> 2023년 상생협력법 개정에 따라 달라지게 되는 사항은?</h2>
                    <div class="text-box">
