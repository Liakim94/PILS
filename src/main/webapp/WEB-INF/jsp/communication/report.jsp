        ...
        <div class="article">
            ...
            <div id="about" class="content">
                <div class="info-link">
                    ...
                    <div class="item" style="width: 30%">
                        <a href="https://www.smes.go.kr/poll/policy/policyAnonymInfo.do">
                            <img class="hover" src="<c:url value="/images/common/document-icon.png"/>" >
                            <img class="unhover" src="<c:url value="/images/common/document-icon2.png"/>">
                            납품대금연동제 익명제보센터</a>
                    </div>
                ...
                <section>
                    ...
                    <h4 class="mb40" style="padding-left: 20px;">
                        ...
                        <p class="tip mt3" style="padding-left: 20px;">* 대·중소기업·농어업협력재단 ☏1357+내선9</p>
