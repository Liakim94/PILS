        ...
        <div class="article">
            ...
            <div class="content" id="agreement">
                ...
                <div class="write-container">
                    <form:form modelAttribute="agreeVO" action="post.do" method="post">
                        ...
                        <div class="write-wrap">
                            ...
                            <div class="line-wrap">
                                ...
                                <div class="input-wrap">
                                    <form:input type="text" path="rqrm_ust" style="width: 20%;"/> <p style="font-weight: 500; display: inline-block;padding-left: 5px;">%</p>
                                </div>
                            </div>
                            <div class="line-wrap">
                                <div class="label">
                            ...
                            <div class="line-wrap">
                                ...
                                <div class="input-wrap">
                                    <form:input type="text" path="ratio" style="width: 20%;" /><p style="font-weight: 500; display: inline-block;padding-left: 5px;">%</p>
                                </div>
                            </div>
                            <div class="line-wrap">
                                <div class="label">
