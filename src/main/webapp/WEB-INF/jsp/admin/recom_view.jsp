                ...
                <div class="write-container">
                    <div class="line-wrap">
                        ...
                        <div class="input-wrap" style="text-align:left" >
                            <input onclick="return(false);" type="radio" <c:if test="${rs.status eq 'Y'}">checked</c:if>/>공개
                            <input onclick="return(false);" type="radio" <c:if test="${rs.status eq 'N'}">checked</c:if>/>비공개
                            </h3>
                        </div>
                    </div>
                    <div class="line-wrap">
