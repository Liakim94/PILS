        ...
        <div class="article">
            ...
            <div class="content">
                ...
                <div class="write-container">
                    <form:form modelAttribute="edit" action="conEdit.do" method="post" >
                        ...
                        <div class="write-wrap">
                            <div class="line-wrap">
                                ...
                                <div class="input-wrap">
                                    <input type="text" value="${rs.instNm}" name="instNm">
                                </div>
                            </div>
                            ...
                            <div class="line-wrap">
                                ...
                                <div class="input-wrap">
                                    <input type="text" value="${rs.contact}" name="contact">
                                </div>
                            </div>
                            <div class="line-wrap">
                                <div class="label">
                                ...
                                <div class="input-wrap">
                                    <input type="text" value="${rs.sortSeq}" name="sortSeq">
                                </div>
                            </div>
