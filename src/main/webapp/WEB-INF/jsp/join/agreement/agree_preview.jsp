...
<div class="print-container">
    ...
    <div id="printArea">
        <div class="page">
            <h1>납품대금 연동 특별약정서</h1>
            <h3>
                원재료의 가격 변동에 따른 납품대금 연동과 관련하여 위탁기업(원사업자를 포함한다. 이하 같다)과 수탁기업(수급사업자를 포함한다. 이하 같다)은 수탁·위탁거래약정에 부수하여 다음과 같이 납품대금 연동 특별약정을 체결한다.                <br>
                <br>
                ◇ 대상 수탁·위탁거래약정 : (명칭)
        ...
        <div class="page">
            <h3>
                <br>
                <b>제3조(원재료 가격 기준지표)</b> 원재료 가격 기준지표는 약정의 당사자가 수탁·위탁거래의성격, 연동 대상 원재료의 특성 등을 고려하여 공신력 있는 기관이 주기적으로 고시하는 지표 또는 이에 준하는 지표로 정함을 원칙으로 한다. 다만, 이와 같은 지표를 사용하는 것이 적절하지 않은 경우에는 다음 각 호와 같이 정할 수 있다.
                <ol>
                    <li>
                ...
                <br>
                <b>제4조(｢납품대금 연동표｣의 작성)</b>
                ① 위탁기업은 수탁기업과 성실하게 협의하여 【첨부1】 ｢납품대금 연동표｣(이하 ‘｢납품대금 연동표｣라 한다)의 각 기재사항을 적는다.<br>
                ② 이 특별약정의 당사자는 ｢납품대금 연동표｣의 각 기재사항과 관련하여 내용을 증명할 수 있는 서류를 제공할 것을 상대방에게 요청할 수 있으며, 이때 요청하는 자료는 ｢납품대금 연동표｣ 작성을 위해 필요한 최소한의 자료에 한한다.<br>
                ③ 제2항의 요청을 받은 상대방은 해당 서류를 성실하게 제공하여야 하며, 서류를 제공받은 당사자는 상대방의 경영정보 및 기술자료 보호 등을 위해 협조한다.<br>
                <br>
                <b>제5조(납품대금 연동 절차)</b>
                ...
                ③ 위탁기업과 수탁기업은 제2항에 따라 물품등의 납품대금이 조정된 경우, 조정대금 반영일, 비교시점의 원재료 기준가격 및 조정된 납품단가를 【첨부2】 ｢납품단가 변동표｣
                (이하 ‘｢납품단가 변동표｣’라 한다)에 기재하고 서명(｢전자서명법｣ 제2조 제2호에 따른 전자서명을 포함한다) 또는 기명날인한다.<br>
        ...
        <div class="page">
            <h3>
                ...
                <br>
                <b>제7조(서류의 비치)</b>
                위탁기업과 수탁기업은 이 특별약정서와 이에 부속되는 ｢납품대금 연동표｣ 및 ｢납품단가 변동표｣를 거래의 종료일부터 3년간 갖추어 두어야 한다.<br>
                <br>
                <br>
