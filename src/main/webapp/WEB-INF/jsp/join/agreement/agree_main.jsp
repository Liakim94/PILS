    ...
    <div id="board">
        ...
        <div class="article">
            ...
            <div id="agreement" class="content">
                ...
                <div class="info-link">
                    ...
                    <c:if test="${rs eq '0'}">
                            <a href="${pageContext.request.contextPath}/join/agree.do" >
                                <img class="hover" src="<c:url value="/images/common/document-icon.png"/>" alt="연동표 체험하기">
                                <img class="unhover" src="<c:url value="/images/common/document-icon2.png"/>" alt="연동표 체험하기">
                                연동표 작성 체험</a>
                    </c:if>
                    </div>
                    <div class="item">
                        <a href="<c:url value="/files/표준%20연동계약서·미연동계약서(양식).zip"/>" download="표준 연동계약서_미연동계약서(양식).zip">
                            <img class="hover" src="<c:url value="/images/common/download-icon2.png"/>" alt="연동표 다운로드">
                            <img class="unhover" src="<c:url value="/images/common/download-icon.png"/>" alt="연동표 다운로드">
                             양식 다운로드</a>
                    </div>
                    <div class="item">
                ...
                <h3 >위탁기업과 수탁기업은 다음 사항에 대해 충분히 협의하여 연동표에 기재해야 합니다.</h3>
                ...
                <div class="accordion-container">
                    ...
                    <div class="item-wrap" onclick="detailOpen(this)" tabindex="1">
                        ...
                        <div class="detail-info">
                            <div class="info-box">
                                <section>
                                    <p class="text">&#9634; &nbsp;위탁기업이 수탁기업에 제조를 위탁한 물품등으로서, 그 납품대금이 이 연동약정에 따라 납품대금 연동의 대상이 되는 것의 명칭을 기재 합니다.</p>
