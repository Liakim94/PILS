            ...
            <div id="about" class="content concept">
                ...
                <section class="temp">
                    <div class="page">
                        <h1>납품대금 연동 특별약정서</h1>
                        <h3>
                            원재료의 가격 변동에 따른 납품대금 연동과 관련하여 위탁기업(원사업자를 포함한다. 이하 같다)과 수탁기업(수급사업자를 포함한다. 이하 같다)은 수탁·위탁거래약정에
                            부수하여 다음과 같이 납품대금 연동 특별약정을 체결한다.
                            <br>
                            <br>
                            ◇ 대상 수탁·위탁거래약정 : (명칭)
                            ...
                            <br>
                            <br>
                            <b>제1조(목적)</b> 이 특별약정은 상기 수탁·위탁거래약정과 관련하여, 주요 원재료의 가격이 상승 또는 하락하여 변동하는 경우, 그 변동분에 연동한
                            납품대금(납품단가를 포함한다. 이하 같다)의 조정(이하 ‘납품대금 연동’이라 한다)에 필요한 제반 사항을 규정함을 목적으로 한다.
                            <br>
                            <br>
                            <b>제2조(정의)</b> ① 이 특별약정에서 사용하는 용어의 뜻은 다음과 같다.
                            <ol>
                                <li>
                                    ‘수탁·위탁거래’란 제조, 공사, 가공, 수리, 판매, 용역을 업(業)으로 하는 자가 물품, 부품, 반제품(半製品) 및 원료 등(이하 ‘물품등’이라
                                    한다)의 제조, 공사, 가공, 수리, 용역 또는 기술개발(이하 ‘제조’라 한다)을 다른 중소기업에 위탁하고, 제조를 위탁받은 중소기업이 전문적으로
                                    물품등을 제조하는 거래를 말한다.
                                </li>
                                <li>
                                    ‘주요 원재료’란 수탁기업이 물품등의 제조에 사용할 원재료(천연재료, 화합물, 가공물, 중간재 등을 포함하되 이에 한정하지 아니한다)로서 해당 가격
                                    변동 시, 납품대금 연동을 하기로 위탁기업과 수탁기업이 협의하여 정한 원재료를 말한다.
                                </li>
                                <li>
                                ...
                                <li>
                                    ‘조정 주기’란 조정요건을 감안하여 납품대금 연동의 시행 여부를 판단하는 주기를 말하며, ‘조정일’이란 그 조정 주기에 따라 납품대금 연동의 시행
                                    여부를 판단하는 날을 말한다.
                                </li>
                                <li>
                            ...
                            <br>
                            <br>
                            <b>제3조(원재료 가격 기준지표)</b> ① 원재료 가격 기준지표는 약정의 당사자가 수탁·위탁거래의 성격, 주요 원재료의 특성 등을 고려하여 공신력 있는 기관이
                            주기적으로 고시하는 지표 또는 이에 준하는 지표로 정함을 원칙으로 한다. 다만, 이와 같은 지표를 사용하는 것이 적절하지 않은 경우에는 다음 각 호와 같이 정할 수
                            있다.
                            <ol>
                                <li>
                            ...
                            ② 이 특별약정의 당사자는 원재료 가격 기준지표 등을 정함에 있어 관련 내용을 증명할 수 있는 서류를 제공할 것을 상대방에게 요청할 수 있으며, 해당 서류를 제공받은
                            당사자는 상대방의 경영정보 및 기술자료 보호 등을 위해 협조한다.
                            <br>
                            <br>
                            <b>제4조(납품대금 연동)</b> ① 위탁기업과 수탁기업은 【첨부1】 ｢납품대금 연동 특별약정서 (별첨)｣(이하 ‘｢별첨｣’이라 한다)에 따라 조정일마다 주요
                            원재료 기준가격의 기준시점 대비 비교시점의 변동률을 확인하고, 그 변동률이 조정요건을 충족하는 경우 납품대금 연동 산식에 따라 물품등의 납품대금의 금액을
                            산출한다.<br>
                            ② 위탁기업은 제1항에 따라 산출된 금액을 기준으로 물품등의 납품대금을 조정한다.<br>
                            ③ 위탁기업과 수탁기업은 제2항에 따라 물품등의 납품대금이 조정된 경우, 조정대금 반영시점, 조정된 원재료 기준가격 및 조정된 납품단가를 【첨부2】 ｢납품단가
                            변동표｣(이하 ‘｢납품단가 변동표｣’라 한다)에 기재하고 서명(｢전자서명법｣ 제2조 제2호에 따른 전자서명을 포함한다) 또는 기명날인한다.<br>
                            ④ 제3항에도 불구하고, ｢납품단가 변동표｣의 기재 사항을 모두 포함하는 전자문서로 양 당사자가 내용을 확인할 수 있는 경우에는 당해 전자문서로 ｢납품단가 변동표｣를
                            갈음할 수 있다.<br>
                            ⑤ 위탁기업은 조정대금 반영시점 이후에 납품되는 물품등에 대하여 제2항에 따라 조정된 금액을 기준으로 납품대금을 지급한다.
                            ⑥ 조정대금 반영시점 이전에 수탁·위탁거래약정의 이행이 완료되어야 하나 수탁기업에 책임있는 사유로 완료되지 않은 부분에 대해서는 그 조정대금 반영시점의 납품대금
                            연동을 적용하지 아니한다.
                            <br>
                            <br>
