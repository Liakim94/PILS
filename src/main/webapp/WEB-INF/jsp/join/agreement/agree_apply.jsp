                                ...
                                <div class="info-box">
                                    <section>
                                        ...
                                        <ul>
                                            ...
                                            <li>주 투입 원재료가 단수이거나 여러 원재료가 동시에 투입되는 경우라도 투입 원재료의 특정 및 원재료별 투입비율 등에 대한 확인이
                                                가능한 원재료
                                            </li>
                                        </ul>
                        ...
                        <div class="line-wrap">
                            <div class="line-wrap">
                                ...
                                <div class="input-wrap br">
                                    <input type="number" id="std_point" name="std_point" required/>
                                </div>
                                <div class="label bg-none">
                                    비교시점
                                </div>
                                <div class="input-wrap">
                                    <input type="number" id="change_point" name="change_point" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="line-wrap">
                            ...
                            <div class="input-wrap">
                                ...
                                <div class="info-box">
                                    <section>
                                        <h3>5. 조정 요건</h3>
                                        <p class="text">&#9634; 주요 원재료의 기준가격의 기준시점 대비 비교시점의 변동률을 근거로 정한 납품대금 연동을
                                            시행하는 요건을 기재합니다.</p>
