...
! function r(s, a, l) {
    ...
    3: [function (t, e, i) {
        ...
        function o(t) {
            if (!0 !== t._muiDropdown) {
                t._muiDropdown = !0;
                var e = t.tagName;
                "INPUT" !== e && "BUTTON" !== e || t.hasAttribute("type") || (t.type = "button"), u.on(t, "click", r)
            }
        }
            ...
            if (0 === t.button) {
                null === this.getAttribute("disabled") && function (t) {
                    var e = t.parentNode,
                        ...
                        n = e.ownerDocument;
                    if (!i || !u.hasClass(i, m)) return c.raiseError("Dropdown menu element not found");

                    function o() {
                        u.removeClass(i, d), u.off(n, "click", o), u.off(n, "keydown", r)
                    }
                    ...
                    u.hasClass(i, d) ? o() : (s = e.getBoundingClientRect(), a = t.getBoundingClientRect(), l = a.top - s.top + a.height, u.css(i, "top", l + "px"), u.addClass(i, d), setTimeout(function () {
    ...
    4: [function (t, e, i) {
        ...
        e.exports = {
            ...
            onAnimationStart: function (t, e) {
                var i = s[t];
                i || (i = s[t] = []), i.push(e), this.init || (function () {
                    for (var t, e = [
    ...
    6: [function (t, e, i) {
        ...
        function a(e, t, i, n) {
            ...
            t.split(" ").map(function (t) {
                for (o = a[t] || [], s = o.length; s--;) r = o[s], (void 0 === i || r[0] === i && r[1] === n) && (o.splice(s, 1), e.removeEventListener(t, r[0], r[1]))
            })
        }
    ...
    7: [function (t, e, i) {
        ...
        e.exports = {
            ...
            disableScrollLock: function (t) {
                0 !== f && 0 == (f -= 1) && (m.removeClass(document.body, p), t && window.scrollTo(l.left, l.top), m.off(window, "scroll", c, !0), setTimeout(function () {
        ...
        e.exports = function (t) {
            ...
            if ("on" === t) {
                ...
                void 0 === (n = n || {}).keyboard && (n.keyboard = !0), void 0 === n.static && (n.static = !1), e = function (t, e) {
                    ...
                    if (n.activeElement && (s = n.activeElement), a.enableScrollLock(), r) {
                        for (; r.firstChild;) r.removeChild(r.firstChild);
                        e && r.appendChild(e)
                    } else(r = n.createElement("div")).setAttribute("id", u), r.setAttribute("tabindex", "-1"), e && r.appendChild(e), o.appendChild(r);
                    return c.test(navigator.userAgent) && l.css(r, "cursor", "pointer"), t.keyboard ? l.on(document, "keyup", f) : m(), t.static ? p(r) : (i = r, l.on(i, "click", h)), r.muiOptions = t, r.focus(), r
                }(n, o)
    ...
    10: [function (t, e, i) {
        ...
        p.prototype._createMenuEl = function (t, e) {
            ...
            0 !== this.currentPos && (y.removeClass(this.itemArray[this.currentPos], C), this.currentPos -= 1, y.addClass(this.itemArray[this.currentPos], C))
...
! function (a) {
    a.fn.progressTracker = function (b) {
        function d() {
            if ("viewport" == c.tracking) var b = a(window).scrollTop();
            else var b = a(".progress-tracker").offset().top;
            a(".pt-section").each(function (d) {
                var e = a(this),
                    f = e.offset().top,
                    g = f + e.outerHeight(),
                    h = e.attr("id");
                a.isNumeric(c.positiveTolerance) && (f += c.positiveTolerance, g += c.positiveTolerance), a.isNumeric(c.negativeTolerance) && (f -= c.negativeTolerance, g -= c.negativeTolerance), b >= f && g >= b && (a(".progress-tracker ul li").removeClass("active"), a(".progress-tracker ul li.section-" + h).addClass("active"))
            })
        }

        function e() {
            if (!c.displayWhenActive) return !1;
            var b = a(".progress-tracker"),
                d = a(".pt-section:first").offset().top,
                e = a(".pt-section:last").offset().top + a(".pt-section:last").outerHeight();
            b.offset().top >= d && b.offset().top <= e ? b.removeClass("hide") : b.addClass("hide")
        }

        function g() {
            a(window).width() <= c.disableBelow ? a(".progress-tracker").hide() : a(".progress-tracker").show()
        }
        var c = a.extend({
            linking: !0,
            tooltip: "constant",
        ...
        if (a("body").append('<div class="progress-tracker"><ul></ul></div>'), a(".pt-section").each(function (b) {
                var d = a(this),
                    e = d.attr("id"),
                    f = d.data("name") || "",
                    g = "",
                    h = "";
                c.linking && (g = '<a class="pt-circle" href="#' + e + '"></a>'), c.tooltip && f.length && (h = "<span class='pt-description'><span>" + f + "</span></span>"), a(".progress-tracker ul").append('<li class="section-' + e + '">' + g + h + "</li>"), a(".progress-tracker").css({
                    "margin-top": "-" + a(".progress-tracker").height() / 2 + "px"
                })
            }), c.linking && a(".progress-tracker ul li a.pt-circle").on("click", function (b) {
                b.preventDefault();
                var c = a(this).attr("href");
                a("html, body").animate({
                    scrollTop: a(c).offset().top + 1
                }, 1e3)
            }), "hover" == c.tooltip ? a(".progress-tracker ul li").hover(function () {
                a(this).find(".pt-description").show()
            }, function () {
                a(this).find(".pt-description").hide()
            }) : "constant" == c.tooltip && a(".progress-tracker").addClass("constant"), a(window).scroll(function () {
                d(), e()
            }), a(document).ready(function () {
                d(), e()
            }), c.disableBelow > 0 && a.isNumeric(c.disableBelow)) {
            var f;
            a(window).resize(function () {
                clearTimeout(f), f = setTimeout(g, 150)
            }), g()
        }
    }
}(jQuery);
